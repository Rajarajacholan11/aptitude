...
document.addEventListener("DOMContentLoaded", function () {
    document.getElementById("page1").innerHTML = renderQuestionsFromObject(aptitudeQuestions,100,109);

    document.getElementById("page2").innerHTML = renderQuestionsFromObject(aptitudeQuestions,110,119);

    document.getElementById("page3").innerHTML = renderQuestionsFromObject(aptitudeQuestions,120,129);

    document.getElementById("page4").innerHTML = renderQuestionsFromObject(aptitudeQuestions,130,139);

    document.getElementById("page5").innerHTML = renderQuestionsFromObject(aptitudeQuestions,140,149);
});

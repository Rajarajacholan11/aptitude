...
document.addEventListener("DOMContentLoaded", function () {
    document.getElementById("page1").innerHTML = renderQuestionsFromObject(aptitudeQuestions,150,159);

    document.getElementById("page2").innerHTML = renderQuestionsFromObject(aptitudeQuestions,160,169);

    document.getElementById("page3").innerHTML = renderQuestionsFromObject(aptitudeQuestions,170,179);

    document.getElementById("page4").innerHTML = renderQuestionsFromObject(aptitudeQuestions,180,189);

    document.getElementById("page5").innerHTML = renderQuestionsFromObject(aptitudeQuestions,190,199);
});

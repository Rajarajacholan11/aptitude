...
document.addEventListener("DOMContentLoaded", function () {
    document.getElementById("page1").innerHTML = renderQuestionsFromObject(aptitudeQuestions,200,209);

    document.getElementById("page2").innerHTML = renderQuestionsFromObject(aptitudeQuestions,210,219);

    document.getElementById("page3").innerHTML = renderQuestionsFromObject(aptitudeQuestions,220,129);

    document.getElementById("page4").innerHTML = renderQuestionsFromObject(aptitudeQuestions,230,239);

    document.getElementById("page5").innerHTML = renderQuestionsFromObject(aptitudeQuestions,240,249);

    document.getElementById("page6").innerHTML = renderQuestionsFromObject(aptitudeQuestions,250,259);
